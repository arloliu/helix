...
//
// Why this package exists separately from internal/test/integration:
//   - internal/test/integration shares one container pair across all tests via TestMain.
...
//   - Use unique table-name suffixes per test (mirrors internal/test/integration
