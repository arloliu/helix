...
// because gocql v1 keeps the concrete frame types for these codes
// unexported; the code comparison covers both drivers.
...
// Batch wraps a gocql v1 batch. The gocql batch is the single source of truth for
